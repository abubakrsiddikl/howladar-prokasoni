...
exports.deleteImageFromCLoudinary = exports.cloudinaryUpload = exports.uploadBufferToCloudinary = void 0;
...
const uploadBufferToCloudinary = (buffer, fileName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log(error);
        throw new AppError_1.default(401, `Error Buffer uploading file : ${error.message}`);
    }
});
