...
router.patch("/:orderId/status", (0, checkAuth_1.checkAuth)(user_interface_1.Role.ADMIN, user_interface_1.Role.STORE_MANAGER), (0, validateRequest_1.validateRequest)(order_validation_1.updateOrderStatusZodSchema), order_controller_1.OrderController.updateOrderStatus);
